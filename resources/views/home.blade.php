            ...
            <div class="card profile-box">
                <div class="card-body">
                    <div class="media media-wrapper justify-content-between">
                        <div class="media-body">
                            <div class="greeting-user">
                                <h4 class="f-w-600">Welcome to Eraivan Nagar</h4>
                                <p>Here whats happing in your account today</p>
                                <div class="whatsnew-btn"><a class="btn btn-outline-white">
                                    <div class="badge f-10 p-0" id="txt"></div></a></div>
                            </div>
                        </div>
                        <div>
                            <div class="clockbox">
                    ...
                    <div class="cartoon"><img class="img-fluid"
                            src="{{ asset('assets/backend/images/dashboard/cartoon.svg') }}"
                        ...
                        <div class="card-body">
                            <div class="widget-content">
                                <div class="widget-round secondary">
                                    <div class="bg-round">
                                        <svg class="svg-fill">
                                            <use href="{{ asset('assets/backend/svg/icon-sprite.svg#cart') }}"> </use>
                                        </svg>
                                        <svg class="half-circle svg-fill">
                                            <use href="{{ asset('assets/backend/svg/icon-sprite.svg#halfcircle') }}"></use>
                                        </svg>
                                    </div>
                                </div>
                                <div>
                            ...
                            <div class="card-body">
                                <div class="widget-content">
                                    <div class="widget-round primary">
                                        <div class="bg-round">
                                            <svg class="svg-fill">
                                                <use href="{{ asset('assets/backend/svg/icon-sprite.svg#tag') }}"> </use>
                                            </svg>
                                            <svg class="half-circle svg-fill">
                                                <use href="{{ asset('assets/backend/svg/icon-sprite.svg#halfcircle') }}">
                                                </use>
                                            </svg>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="widget-content">
                                <div class="widget-round warning">
                                    <div class="bg-round">
                                        <svg class="svg-fill">
                                            <use href="{{ asset('assets/backend/svg/icon-sprite.svg#return-box') }}">
                                            </use>
                                        </svg>
                                        <svg class="half-circle svg-fill">
                                            <use href="{{ asset('assets/backend/svg/icon-sprite.svg#halfcircle') }}">
                            ...
                            <div class="card-body">
                                <div class="widget-content">
                                    <div class="widget-round success">
                                        <div class="bg-round">
                                            <svg class="svg-fill">
                                                <use href="{{ asset('assets/backend/svg/icon-sprite.svg#rate') }}"> </use>
                                            </svg>
                                            <svg class="half-circle svg-fill">
                                                <use href="{{ asset('assets/backend/svg/icon-sprite.svg#halfcircle') }}">
                                                </use>
