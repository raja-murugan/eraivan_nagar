...
<body>
    ...
    <div class="body-wrapper">
        ...
        <div class="ltn__breadcrumb-area text-left bg-overlay-white-30 bg-image " data-bs-bg="{{ asset('assets/frontend/img/bg/14.jpg') }}">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href="javascript:void(0)"><img src="{{ asset('assets/frontend/img/blog/1.jpg') }}" alt="#"></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href="javascript:void(0)"><img src="{{ asset('assets/frontend/img/blog/2.jpg') }}" alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href="javascript:void(0)"><img src="{{ asset('assets/frontend/img/blog/3.jpg') }}" alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href="javascript:void(0)"><img src="{{ asset('assets/frontend/img/blog/4.jpg') }}" alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href="javascript:void(0)"><img src="{{ asset('assets/frontend/img/blog/5.jpg') }}" alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href="javascript:void(0)"><img src="{{ asset('assets/frontend/img/blog/6.jpg') }}" alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href="javascript:void(0)"><img src="{{ asset('assets/frontend/img/blog/7.jpg') }}" alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href="javascript:void(0)"><img src="{{ asset('assets/frontend/img/blog/8.jpg') }}" alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href="javascript:void(0)"><img src="{{ asset('assets/frontend/img/blog/9.jpg') }}" alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href="javascript:void(0)"><img src="{{ asset('assets/frontend/img/blog/10.jpg') }}" alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href="javascript:void(0)"><img src="{{ asset('assets/frontend/img/blog/11.jpg') }}" alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href="javascript:void(0)"><img src="{{ asset('assets/frontend/img/blog/12.jpg') }}" alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href="javascript:void(0)"><img src="{{ asset('assets/frontend/img/blog/13.jpg') }}" alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href="javascript:void(0)"><img src="{{ asset('assets/frontend/img/blog/14.jpg') }}" alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="ltn__blog-item ltn__blog-item-3">
                            <div class="ltn__blog-img">
                                <a href="javascript:void(0)"><img src="{{ asset('assets/frontend/img/blog/15.jpg') }}" alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
        ...
        <div class="ltn__call-to-action-area call-to-action-6 before-bg-bottom" data-bs-bg="{{ asset('assets/frontend/img/1.jpg') }}">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div
